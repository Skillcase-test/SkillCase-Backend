...
const TERMS_S3_BUCKET = process.env.TERMS_S3_BUCKET || INTERVIEW_S3_BUCKET || "";
const TERMS_S3_REGION =
  process.env.TERMS_S3_REGION || INTERVIEW_S3_REGION || AWS_REGION;
const TERMS_S3_ACCESS_KEY_ID =
  process.env.TERMS_S3_ACCESS_KEY_ID || INTERVIEW_S3_ACCESS_KEY_ID || AWS_ACCESS_KEY_ID;
const TERMS_S3_SECRET_ACCESS_KEY =
  process.env.TERMS_S3_SECRET_ACCESS_KEY || INTERVIEW_S3_SECRET_ACCESS_KEY || AWS_SECRET_ACCESS_KEY;
const TERMS_S3_PUBLIC_BASE_URL = process.env.TERMS_S3_PUBLIC_BASE_URL || "";
const TERMS_UPLOAD_URL_EXPIRY_SECONDS = Number(
  process.env.TERMS_UPLOAD_URL_EXPIRY_SECONDS || 900,
);
const TERMS_DOWNLOAD_URL_EXPIRY_SECONDS = Number(
  process.env.TERMS_DOWNLOAD_URL_EXPIRY_SECONDS || 604800,
);
const TERMS_TOKEN_TTL_HOURS = Number(process.env.TERMS_TOKEN_TTL_HOURS || 72);
const TERMS_ENFORCEMENT_ENABLED =
  String(process.env.TERMS_ENFORCEMENT_ENABLED || "false").toLowerCase() === "true";
